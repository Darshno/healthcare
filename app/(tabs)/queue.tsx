          ...
          <>
            ...
            <View style={styles.summary}>
              ...
              <Text style={styles.summaryText}>
                {entries.length} patients active · {entries.filter((entry) => entry.priority === "emergency" || entry.priority === "urgent").length} high-risk
              </Text>
            </View>
          </>
        }
...
const styles = StyleSheet.create({
  ...
  summary: { alignItems: "center", backgroundColor: "#E6F5F3", borderRadius: 13, flexDirection: "row", gap: 8, marginVertical: 14, padding: 12 },
  ...
  empty: { alignItems: "center", marginTop: 18, padding: 22 },
});
